...
""")
    ...
    for day in days_in_template:
        ...
        prompt = (
            ...
            "- Weekly verb focus\n"
            "- Bilingual story: use ONLY the 2-column HTML table format defined in\n"
            "  BILINGUAL_STORY_FORMAT_RULE. Do not also write the story as separate\n"
            "  prose paragraphs before the table — the table is the story.\n"
            "- Grammar point\n"
            "- Example sentences\n"
            "- Translation Practice (Follow exact sentence counts for long vs short days)\n"
            "- Student questions\n"
            "- Closing summary\n"
        )
        ...
        output_file.write(f"<h1>{day_part} ({week_part.title()})</h1>\n")
        # End Gene's insert
